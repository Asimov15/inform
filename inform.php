...
<body>
    ...
    <div id="wrapper">
        <?php 
            ...
            $FIXER_API_KEY = "b9c6a28b6be2e9bd243c14a77766ea32"; //forex
            $params = new \stdClass();
            ...
            // echo($btc_price_aud);
            //echo(PHP_EOL);
            echo('              <span class="time">1 BTC = $AUD ' . money_format('%9.2i', $btc_price_aud) . '</span>');
            ...
            echo('          </h2>' . PHP_EOL);           
            echo('              <span class="time">Gold: $' . money_format('%7.2i', $gold_aud) . ' per ounce' . '</span>' . PHP_EOL);   
            echo('          </h2>' . PHP_EOL);
            echo('          </div>' . PHP_EOL);
